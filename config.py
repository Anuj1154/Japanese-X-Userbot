...
ALIVE_LOGO = getenv("ALIVE_LOGO", "https://telegra.ph/file/93d22eb580bcaef0fd877.jpg")
...
CHANNEL = getenv("CHANNEL", "myheart_voice")
CMD_HANDLER = getenv("CMD_HANDLER", ".")
DB_URL = getenv("DATABASE_URL", "")
GIT_TOKEN = getenv("GIT_TOKEN", "")
GROUP = getenv("GROUP", "myheart_voice")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
PMPERMIT_PIC = getenv("PMPERMIT_PIC", None)
PM_AUTO_BAN = strtobool(getenv("PM_AUTO_BAN", "True"))
REPO_URL = getenv("REPO_URL", "https://github.com/Anuj1154/Japanese-X-Userbot")
